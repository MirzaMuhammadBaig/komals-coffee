      ...
      <div className="container-base">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {featuredReviews.slice(0, 6).map((r, idx) => (
            <figure
              key={idx}
              className="group relative overflow-hidden rounded-3xl bg-espresso-700/40 p-6 ring-1 ring-cream-100/10 backdrop-blur transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-espresso-700/55 hover:ring-caramel-400/40 hover:shadow-[0_30px_60px_-30px_rgba(224,163,100,0.45)] sm:p-7"
            >
              ...
              <Quote className="absolute right-6 top-6 h-8 w-8 text-caramel-400/40 transition-all duration-500 group-hover:scale-110 group-hover:text-caramel-400/70" />
              ...
              <blockquote className="relative mt-4 text-base leading-relaxed text-cream-100/90">
                &ldquo;{r.body}&rdquo;
              </blockquote>
              <figcaption className="relative mt-6 flex items-center justify-between border-t border-cream-100/10 pt-4 text-xs text-cream-100/60">
