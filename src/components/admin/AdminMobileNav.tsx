 ...
 * Lives in the topbar; hidden on desktop where the static sidebar is used.
 */
  ...
  return (
    <>
      ...
      >
        ...
        >
          <header className="flex items-center justify-between border-b border-espresso-100 px-5 py-4">
            <Link
              href="/admin"
              onClick={() => setOpen(false)}
