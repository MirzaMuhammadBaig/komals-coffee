    ...
    <section className="group relative overflow-hidden bg-espresso-800 text-cream-50">
      ...
      <div className="container-base relative grid min-h-[88vh] items-center py-20 sm:min-h-[90vh] sm:py-24 lg:min-h-[92vh] lg:py-28">
        <div className="max-w-3xl">
          {/* Eyebrow status chip */}
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-cream-100/20 bg-cream-50/5 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.3em] text-cream-100/80 backdrop-blur">
            <Sparkles className="h-3 w-3 text-caramel-400" />
            <span>Open · Brewing now</span>
